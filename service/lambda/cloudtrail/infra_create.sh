...
sed -i '' "/^var FILTER_CONFIG_BUCKET =/s/BUCKETNAME/$BUCKETNAME/g" CloudTrail.js

cp filter_config.json filter_config.json.orig
sed -i '' "s/REGION/$REGION/g" filter_config.json
sed -i '' "s/TOPICARN/$TOPIC_ARN/g" filter_config.json
